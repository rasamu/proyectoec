...
(function($) {
    $.fn.lavaLamp = function(o) {
        ...
        return this.each(function(index) {
            ...
            /*Buscamos el boton donde nos encontramos*/
            var aux=0;
            var seleccionado=0;
            while(aux<=5){
            	if($('#menu_comunidad ul li:eq('+aux+')').hasClass('selected')){
            		seleccionado=aux;
            	}
            	aux++;	
            }/*Fin*/
            ...
            var me = $(this), noop = function(){},
                ...
                $li = $(">li", this), curr = $("li.current", this)[seleccionado] || $($li[seleccionado]).addClass("current")[0];
