...
;(function(e,t,n){
	function o(t,n){
		...
		this.init()}var r={
			...
			open:function(){},
			close:function(){}},
			i="slicknav_comunidad",
			s="slicknav_comunidad";
			o.prototype.init=function(){
				...
				if(i.duplicate){
					...
					n.btn=e(["<"+i.parentTag+' aria-haspopup="true" tabindex="0" class="'+s+"_btn "+s+'_collapsed">','<span id="label_comunidad" class="'+s+'_menutxt">'+i.label+"</span>",'<span class="'+o+'">','<span class="'+s+'_icon-bar"></span>','<span class="'+s+'_icon-bar"></span>','<span class="'+s+'_icon-bar"></span>',"</span>","</"+i.parentTag+">"].join(""));
					e(u).append(n.btn);
					...
					e(a).each(function(){
						...
						if(r.children.length>0){
							...
							e(nodes).last().after(l)}else if(t.children().length===0){t.addClass(s+"_txtnode")}
			...
			o.prototype._visibilityToggle=function(t,n,r,i,o){
				...
				if(t.hasClass(s+"_hidden")){
					...
					t.slideUp(l,this.settings.easingClose,function(){
						...
						t.hide();e(i).removeClass(s+"_animating");
						e(n).removeClass(s+"_animating");
						if(!o){
							a.close(i)
						}else if(i=="init"){
